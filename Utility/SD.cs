...
namespace Spice.Utility
{
    public static class SD
    {
        ...
        public const string ImageStatusSubmitted = @"/images/OrderPlaced.png";
        public const string ImageStatusInProcess = @"/images/InKitchen.png";
        public const string ImageStatusReady = @"/images/ReadyForPickup.png";
        public const string ImageStatusCompleted = @"/images/completed";
